    ...
    <div class="col-lg-12">
        ...
        <div class="container">
            <form method="POST" action="{{ route('adding.product') }}">
                ...
                <div class="form-group">
                    <label for="exampleInputWeight">Weight <span class="required">*</span></label>
                    <input required name="weight" type="text" class="form-control" id="" aria-describedby="descriptionHelp" placeholder="Enter description">
                    @if($errors->has('weight'))
                    <small id="descriptionHelp" class="form-text text-muted">{{$errors->first('weight')}}</small>
                    @endif
                </div>
                <div class="form-group">
                    <label for="exampleInputPrice">Price <span class="required">*</span></label>
                ...
                <div class="form-group">
                    <label for="exampleInputStock">Stock <span class="required">*</span></label>
